...
(function() {
    ...
    // Fade in khi trang mới load
    overlay.classList.remove('active');

    // Bắt tất cả link nội bộ
    document.addEventListener('click', function(e) {
        var link = e.target.closest('a[href]');
        if (!link) return;

        var href = link.getAttribute('href');
        // Bỏ qua link external, anchor, javascript:, modal trigger
    ...
    // Fade in trên body nếu có class loading
