...
-- =====================================================
-- Seed data: Blog posts - Sarah Johnson
-- =====================================================
...
-- =====================================================
-- Seed data: Blog posts - Mike Chen
-- =====================================================
INSERT INTO `BaiViet` (`TieuDe`, `NoiDung`, `TomTat`, `NgayDang`, `ThoiGianDoc`, `LuotXem`, `ID_NguoiDung`, `ID_The_Loai`) VALUES
(
...
-- =====================================================
-- Seed data: Blog posts - Emma Wilson
-- =====================================================
INSERT INTO `BaiViet` (`TieuDe`, `NoiDung`, `TomTat`, `NgayDang`, `ThoiGianDoc`, `LuotXem`, `ID_NguoiDung`, `ID_The_Loai`) VALUES
(
...
-- =====================================================
-- Seed data: Blog posts - Alex Rivera
-- =====================================================
INSERT INTO `BaiViet` (`TieuDe`, `NoiDung`, `TomTat`, `NgayDang`, `ThoiGianDoc`, `LuotXem`, `ID_NguoiDung`, `ID_The_Loai`) VALUES
(
...
-- =====================================================
-- Seed data: Blog posts - Lisa Park
-- =====================================================
INSERT INTO `BaiViet` (`TieuDe`, `NoiDung`, `TomTat`, `NgayDang`, `ThoiGianDoc`, `LuotXem`, `ID_NguoiDung`, `ID_The_Loai`) VALUES
(
...
-- =====================================================
-- Seed data: Reviews - 1 per user (including admin)
-- =====================================================
INSERT INTO `Reviews` (`HoTen`, `Email`, `NoiDung`) VALUES
